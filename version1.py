...
#모든 UI 및 변수 초기화를 담당하는 생성자 메소드.
    def __init__(self):
        ...
        # URL 설정
        self.moonraker_base_url = "http://3dro.kr:3001"
        self.webcam_url = "http://3dro.kr:3001/webcam/"
...
#프린터 제어 기능구현:
    ...
    def crop_print_area(self, frame):
        ...
        try:
            ...
            # 기본 크롭 비율 설정
            initial_width_ratio = 0.35    # 초기 너비 비율
            fixed_top_ratio = 0.2         # 고정된 상단 비율
            initial_bottom_ratio = 0.3    # 초기 하단 비율
            
            # 최대 크롭 비율 설정
            max_width_ratio = 0.7         # 최대 너비 비율
            max_bottom_ratio = 0.6        # 최대 하단 비율
            
            # 시간에 따른 성장률
            width_growth_per_minute = 0.05    # 분당 너비 성장률
            bottom_growth_per_minute = 0.05   # 분당 하단 성장률
